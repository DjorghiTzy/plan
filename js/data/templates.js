...
(function (root) {
  ...
  const SUGGESTIONS = [
    ...
    },
    {
      id: 'senin-kerja',
      emoji: '🗓️',
      name: 'Senin: Rencanakan Pekan',
      description: 'Tentukan target pekan, samakan langkah dengan tim, lalu pecah pekerjaan besar menjadi langkah kecil.',
      tasks: [
        t('Tinjau target & tenggat pekan ini', '08:00', '08:30', 'kerja', 'tinggi', true),
        t('Rapat koordinasi awal pekan', '08:30', '09:30', 'kerja'),
        t('Kerja fokus: prioritas utama pekan', '09:30', '11:30', 'kerja', 'tinggi', true),
        t('Balas email & pesan tertunda', '13:00', '14:00', 'kerja'),
        t('Pecah tugas besar jadi langkah kecil', '14:00', '15:00', 'kerja'),
        t('Masukkan rapat & tenggat ke kalender', '15:00', '15:30', 'kerja', 'rendah'),
      ],
    },
    {
      id: 'rapat',
      emoji: '🤝',
      name: 'Hari Penuh Rapat',
      description: 'Rapat beruntun tanpa kehilangan arah: siapkan agenda, catat tindak lanjut, kirim notulen.',
      tasks: [
        t('Siapkan agenda & bahan rapat', '08:00', '08:45', 'kerja', 'tinggi', true),
        t('Rapat 1', '09:00', '10:00', 'kerja'),
        t('Catat hasil & tindak lanjut', '10:00', '10:15', 'kerja'),
        t('Rapat 2', '10:30', '11:30', 'kerja'),
        t('Rapat 3', '13:00', '14:00', 'kerja'),
        t('Kirim notulen & bagi tugas', '14:00', '14:30', 'kerja', 'tinggi'),
        t('Kerja fokus singkat', '14:30', '16:00', 'kerja'),
      ],
    },
    {
      id: 'jumat-review',
      emoji: '📊',
      name: 'Jumat: Tinjau & Laporkan',
      description: 'Tuntaskan yang tertunda, tinjau capaian proyek, kirim laporan mingguan, dan siapkan pekan depan.',
      tasks: [
        t('Selesaikan pekerjaan yang tertunda', '08:00', '10:30', 'kerja', 'tinggi', true),
        t('Rapikan berkas & dokumentasi', '10:30', '11:30', 'kerja', 'rendah'),
        t('Tinjau capaian pekan & proyek', '13:30', '14:30', 'kerja', 'tinggi'),
        t('Kirim laporan mingguan', '14:30', '15:00', 'kerja', 'tinggi', true),
        t('Susun rencana pekan depan', '15:00', '16:00', 'kerja'),
        t('Kosongkan kotak masuk & meja kerja', '16:00', '16:30', 'kerja', 'rendah'),
      ],
    },
    {
      id: 'lapangan',
      ...
      description: 'Hari di luar kantor: siapkan materi, kunjungi klien, catat hasil, dan tindak lanjuti di hari yang sama.',
      tasks: [
        t('Siapkan materi & rute kunjungan', '07:30', '08:00', 'kerja'),
        t('Perjalanan ke lokasi pertama', '08:00', '08:45', 'kerja', 'rendah'),
        t('Pertemuan klien 1', '09:00', '10:30', 'kerja', 'tinggi', true),
        t('Pertemuan klien 2', '11:00', '12:00', 'kerja', 'tinggi'),
        t('Catat hasil kunjungan', '13:00', '13:30', 'kerja'),
        t('Tindak lanjut penawaran / proposal', '14:00', '15:30', 'kerja'),
        t('Laporkan hasil kunjungan', '16:00', '16:30', 'kerja'),
      ],
    },
  ];
